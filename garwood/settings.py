"""
Django settings for garwood project.
...
SECRET_KEY = 'yi-#c$vr63y-*$sps6)r!^)(s#&q)89yvh9wa_34hsfpzm(n&d'
...
WSGI_APPLICATION = 'garwood.wsgi.application'
